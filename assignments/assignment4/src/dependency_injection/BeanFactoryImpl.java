...
public class BeanFactoryImpl implements BeanFactory {
    ...
    public Object dealWithPrimitive(Class<?> clazz, Value valueAnnotation) {
        String value = "";
    ...
    public boolean stringToInt(String s) {
        if (s.equals("")) {
            return false;
        } else {
    ...
    public boolean canStringToBool(String s) {
        s = s.toLowerCase();
    ...
    public Object dealWithNonPrimitive(Parameter p, Field field, Value valueAnnotation) {
        Class<?> clazz;
        if (p != null)
            clazz = p.getType();
        else
